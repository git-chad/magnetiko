...
**Done when:** Canvas renders in the editor layout. Responds to window resize. Shows uploaded media through the pipeline. ✓ Fixed layer sync timing (status dep) and zoom pollution (reset on mount).
